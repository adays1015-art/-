...
{JSON.stringify(processRoundtrip.detail, null, 2)}
      ...
      <Modal open={!!printingLot} onClose={() => setPrintingLot(null)}
        ...
        {printingLot && (() => {
          ...
          return (
            <div className="border-2 border-ink-900 rounded-md p-4 font-mono text-sm leading-relaxed space-y-1" id="upcycle-lot-label">
              <div className="text-[10px] uppercase tracking-widest text-ink-500">B.fter · 업사이클 생산 LOT</div>
