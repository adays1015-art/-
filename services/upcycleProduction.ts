...
function toRow(l: ItemLot): (string | number | boolean)[] {
  return [
    ...
    l.intakeDate ?? "", l.intakeWorker ?? "", l.intakeMachine ?? "",
    l.extractionDate ?? "", l.extractionWorker ?? "", l.extractionMachine ?? "",
    l.refiningDate ?? "", l.refiningWorker ?? "", l.refiningMachine ?? "",
    l.agingDate ?? "", l.agingWorker ?? "", l.agingMachine ?? "",
