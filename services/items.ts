...
function fromRow(r: Record<string, string>): Item {
  return {
    ...
    // 빈 값("")은 nullish 가 아니라 ?? 로 기본값이 안 잡혀 생산 목록의
    // status==="사용중" 필터에서 제외됐음 → 빈/공백은 "사용중" 으로 처리.
